...
function start() {
	...
	board1 = new Board("board1", canvas1, canvas2, canvas3, 50, 50, "#FFCE9E" , "#D18B47", "w", true);
	board1.drawBoard();
	board1.drawPieces();
}
...
function Board (name, boardCanvas, piecesCanvas, movingCanvas, boardXOffset, boardYOffset, color1, color2, moveColor, dragEnabled) {
	this.name = name;
